...
# # element whereas the update() method
...
# print(months)
#
# # the pop() method will always remove the last item but the
# # set is unordered, we can't determine which element will be popped from set.
# Months = {"January", "February", "March", "April", "May", "June"}
# print(Months)
# Months.pop()
# Months.pop()
